# 2.1. Prerequisites {.unnumbered}

Before beginning the process of setting up a WiFi sensor, it's essential to ensure you have the necessary hardware *(2.1.1.)*, software *(2.1.2.)*, and skills *(2.1.3.)*.

## 2.1.1. Hardware Components {.unnumbered}
...
## 2.1.2 Required Software {.unnumbered}
...
## 2.1.3. Necessary Skills {.unnumbered}
