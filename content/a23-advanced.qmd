# 2.3. Raspberry Pi Setup {.unnumbered}

This section covers preparing your Raspberry Pi OS *(2.3.1)*, transforming it into a file server for easy file sharing *(2.3.2)*, and configuring it to send status updates to cloud storage for remote monitoring *(2.3.3)*.

## 2.3.1. Prepare Your Raspberry Pi OS
...
## 2.3.2. Transforming Your Pi into a File Server
...
## 2.3.3. Setting Up Cloud Storage Access on Your Pi
