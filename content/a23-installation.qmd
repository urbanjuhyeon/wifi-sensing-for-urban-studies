...
To set up the sensing service on your Raspberry Pi, you'll need to access the scripts located in the [urban-sensing-raspi](https://github.com/urbanjuhyeon/urban-sensing-raspi) GitHub repository.
...
After restarting your Pi, stop the Urban Sensing Service that automatically starts up due to `configure.sh`:
...
3. Look through the 'data' folder:
...
### Step 4: Verify the results without ethernet
