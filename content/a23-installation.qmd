...
**1. Format your SD card:** After inserting an SD card into your laptop, launch the [Raspberry Pi Imager](https://www.raspberrypi.com/software/) and select the `Format SD Card` option to prepare your SD card for the installation.
